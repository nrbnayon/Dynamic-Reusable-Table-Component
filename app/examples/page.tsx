    ...
    <div className="container mx-auto p-6 space-y-8">
      <div className="text-center space-y-4">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Comprehensive examples showcasing all possible configurations and use cases of the dynamic table component
        ...
        <TabsContent value="employee" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Complete HR management with employee profiles, performance tracking, and role management. Features:
                Avatar display, multi-select actions, advanced filtering, and comprehensive edit forms.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <DynamicTable
                ...
                onRefresh={() => handleRefresh(setEmployeeTableData, employeeData)}
              />
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="product" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                E-commerce product management with inventory tracking, pricing, and category organization. Features:
                Stock level indicators, rating displays, and category-based filtering.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <DynamicTable
                ...
                onRefresh={() => handleRefresh(setProductTableData, productData)}
              />
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="customer" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Customer database with purchase history, segmentation, and contact management. Features: Customer
                avatars, spending analytics, and status-based organization.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <DynamicTable
                ...
                onRefresh={() => handleRefresh(setCustomerTableData, customerData)}
              />
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="order" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Complete order processing with status tracking, payment management, and delivery coordination. Features:
                Priority indicators, status workflows, and tracking integration.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <DynamicTable
        ...
        <TabsContent value="project" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Project tracking with budget monitoring, progress visualization, and timeline management. Features:
                Progress bars, budget tracking, and milestone indicators.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <DynamicTable
                ...
                onRefresh={() => handleRefresh(setProjectTableData, projectData)}
              />
            </CardContent>
          </Card>
        </TabsContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>All the features demonstrated across the different table examples</CardDescription>
        </CardHeader>
        <CardContent>
